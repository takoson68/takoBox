...
ul.userBox li div .showsetBtn { border: 2px solid #9f9f9f; padding: .25em .5em; border-radius: 8px; background-color: #3f51b5; margin-left: 1em; color: #fff; cursor: pointer; display: inline-flex; }
